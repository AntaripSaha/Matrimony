<footer class="aiz-footer fs-13 mt-auto text-white fw-400 pt-5">
    <div class="container">
        ...
        <div class="mb-4">
            ...
            <div class="row opacity-95 no-gutters">
                ...
                <div>
                    <ul class="list-unstyled">
                        @foreach (json_decode( get_setting('widget_one_labels'), true) as $key => $value)
                            <li class="my-3">
                                <a href="{{ json_decode( get_setting('widget_one_links'), true)[$key] }}" class="text-reset opacity-85">{{ $value }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div>
                    <ul class="list-unstyled">
                        @foreach (json_decode( get_setting('widget_two_labels'), true) as $key => $value)
                            <li class="my-3">
                                <a href="{{ json_decode( get_setting('widget_two_links'), true)[$key] }}" class="text-reset opacity-85">{{ $value }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div>
                    <ul class="list-unstyled">
                        @foreach (json_decode( get_setting('widget_three_labels'), true) as $key => $value)
                            <li class="my-3">
                                <a href="{{ json_decode( get_setting('widget_three_links'), true)[$key] }}" class="text-reset opacity-85">{{ $value }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
        ...
        <div class="border-top border-primary pt-4 pb-7 pb-xl-5 ">
            <div class="row">
                <div class="col-lg-6">
                    <div class="lh-1">
...
s1.async=true;
s1.src='https://embed.tawk.to/6119f149d6e7610a49b058e8/1fd6ld2fk';
s1.charset='UTF-8';
