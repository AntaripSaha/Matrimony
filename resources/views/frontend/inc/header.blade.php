<div class="@if(get_setting('header_stikcy') == 'on') position-fixed @else position-absolute @endif w-100 top-0 z-1020">
                    ...
                    <ul class="list-inline mb-0 d-flex align-items-center justify-content-end ">
                        ...
                        <li class="list-inline-item mx-4">
                            <a href="{{ route('dashboard') }}" class="d-flex align-items-center text-reset">
                                <img src="{{ URL::to('/public/images/'.Auth::user()->photo) }}"
    ...
    <header
        class="aiz-header shadow-md bg-pink border-gray-300">
            ...
            <div class="container">
                <div class="d-lg-flex justify-content-between text-center text-lg-left">
                    ...
                    <ul
                        ...
                        <li class="d-inline-block d-lg-flex pb-1 {{ areActiveRoutes(['home'],'bg-white') }}">
                            <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-pink py-2"
                                href="{{ route('home') }}">
                                <span class="text-white mb-n1">{{ translate('Home') }}</span>
                            </a>
                        </li>
                        <li
                            class="d-inline-block d-lg-flex pb-1 {{ areActiveRoutes(['member.listing'],'bg-white') }}">
                            <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-pink py-2"
                                href="{{ route('member.listing') }}">
                                <span class="text-white mb-n1">{{ translate('Active Members') }}</span>
                            </a>
                        </li>
                        <li class="d-inline-block d-lg-flex pb-1 {{ areActiveRoutes(['packages'],'bg-white') }}">
                            <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-pink py-2"
                                href="{{ route('packages') }}">
                        ...
                        <li
                            class="d-inline-block d-lg-flex pb-1 {{ areActiveRoutes(['happy_stories'],'bg-white') }}">
                            <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-pink py-2"
