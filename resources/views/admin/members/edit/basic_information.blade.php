...
<div class="card-body">
    ...
    <form action="{{ route('member.basic_info_update', $member->id) }}" method="POST">
        ...
        <div class="form-group row">
            <div class="@if(addon_activation('otp_system')) col-md-6 @else col-md-6 @endif">
        ...
        <div class="form-group row">
            <div class="col-md-12">
              <label class="" for="signinSrEmail">{{translate('Photo 90x90')}}</small></label>
            <input type="file" name="photo" class="selected-files" >
            </div>
        </div>
