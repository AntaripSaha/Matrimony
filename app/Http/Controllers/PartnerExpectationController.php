...
class PartnerExpectationController extends Controller
{
     ...
     */
     public function update(Request $request, $id)
     {
         ...
         $partner_expectations->general                   = $request->general ?? null;
         ...
         $partner_expectations->sub_caste_id              = $request->partner_sub_caste_id ?? null;
         ...
         $partner_expectations->language_id               = $request->language_id ?? null;
